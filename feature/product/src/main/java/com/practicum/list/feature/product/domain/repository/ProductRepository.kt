...
interface ProductRepository {
    ...
    suspend fun updateProduct(product: Product, listId: Long)
    suspend fun addProduct(product: Product, listId: Long)
    suspend fun sortProductsAlphabetically(list: List<Product>) : List<Product>
    suspend fun sortCustom(order: List<Int>)
